...
public sealed class MainViewModel : INotifyPropertyChanged
{
    ...
    private void ApplyPokerActionMix(PokerActionMix? actionMix)
    {
        ...
        var ranked = new[]
        {
            (Name: nameof(CheckPercent), Value: CheckPercent),
            (Name: nameof(CallPercent), Value: CallPercent),
            (Name: nameof(FoldPercent), Value: FoldPercent),
            (Name: nameof(BetPercent), Value: BetPercent)
        };
        ...
        var highlightBrush = Brushes.LimeGreen;
        switch (best.Name)
        {
            case nameof(CheckPercent):
                CheckPercentBrush = highlightBrush;
                break;
            case nameof(CallPercent):
                CallPercentBrush = highlightBrush;
                break;
            case nameof(FoldPercent):
                FoldPercentBrush = highlightBrush;
                break;
            case nameof(BetPercent):
                BetPercentBrush = highlightBrush;
                break;
        }
    }
