...
public sealed class SixMaxTableVisionLayout
{
    ...
    public SixMaxTableVisionLayout()
    {
        ...
        {
            [1] = new(1, new Rectangle(369, 453, 72, 72), new Rectangle(425, 505, 185, 104), NameRoi: new Rectangle(432, 565, 165, 30), StackRoi: new Rectangle(432, 590, 165, 27), BetRoi: new Rectangle(500, 455, 120, 25)),
            [2] = new(2, new Rectangle(297, 432, 104, 80), new Rectangle(124, 500, 192, 104), NameRoi: new Rectangle(134, 510, 170, 30), StackRoi: new Rectangle(130, 535, 170, 27), BetRoi: new Rectangle(269, 450, 120, 25)),
            ...
            [4] = new(4, new Rectangle(400, 165, 120, 94), new Rectangle(414, 76, 192, 104), NameRoi: new Rectangle(426, 125, 170, 30), StackRoi: new Rectangle(426, 145, 170, 27), BetRoi: new Rectangle(421, 212, 120, 25)),
            [5] = new(5, new Rectangle(818, 162, 120, 94), new Rectangle(806, 188, 188, 104), NameRoi: new Rectangle(820, 210, 164, 30), StackRoi: new Rectangle(820, 232, 164, 27), BetRoi: new Rectangle(720, 260, 120, 25)),
            [6] = new(6, new Rectangle(650, 440, 120, 94), new Rectangle(730, 500, 196, 104), NameRoi: new Rectangle(748, 510, 164, 30), StackRoi: new Rectangle(735, 535, 164, 27), BetRoi: new Rectangle(670, 450, 100, 25))
        };
    }
